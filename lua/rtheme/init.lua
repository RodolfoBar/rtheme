...
function M.setup(opts)
  ...
  local highlights = {
    ...
    RenderMarkdownH1              = { fg = colors.blue, bg = "#20293b", bold = true },
    RenderMarkdownH2              = { fg = colors.purple, bg = "#2b223b", bold = true },
    RenderMarkdownH3              = { fg = colors.yellow, bg = "#372724", bold = true },
    RenderMarkdownH4              = { fg = colors.cyan, bg = "#173631", bold = true },
    RenderMarkdownH5              = { fg = colors.green, bg = "#293622", bold = true },
    RenderMarkdownH6              = { fg = colors.red, bg = "#371926", bold = true },
    RenderMarkdownH1Bg            = { fg = colors.blue, bg = "#20293b", bold = true },
    RenderMarkdownH2Bg            = { fg = colors.purple, bg = "#2b223b", bold = true },
    RenderMarkdownH3Bg            = { fg = colors.yellow, bg = "#372724", bold = true },
    RenderMarkdownH4Bg            = { fg = colors.cyan, bg = "#173631", bold = true },
    RenderMarkdownH5Bg            = { fg = colors.green, bg = "#293622", bold = true },
    RenderMarkdownH6Bg            = { fg = colors.red, bg = "#371926", bold = true },
    ...
    RenderMarkdownCodeInline      = { fg = colors.lgreen, bg = colors.black },
    ...
    RenderMarkdownLinkTitle       = { fg = colors.lblue, italic = true, underline = true },
    RenderMarkdownWikiLink        = { fg = colors.lblue, underline = true },
    ...
    ['@markup.link.label']          = { fg = colors.lblue, italic = true, underline = true },
    ['@markup.link.url']            = { fg = colors.lblue, underline = true },
    ...
    -- PERF: THING
    -- TEST: THING
    TodoBgNOTE      = { bg = colors.bg, fg = colors.lblue, bold = true, italic = false },
    TodoFgNOTE      = { fg = colors.white, italic = false },
    TodoSignNOTE    = { fg = colors.lblue, italic = false },
    TodoBgTODO      = { bg = colors.bg, fg = colors.lcyan, bold = true, italic = false },
    TodoFgTODO      = { fg = colors.white, italic = false },
    TodoSignTODO    = { fg = colors.lcyan, italic = false },
    TodoBgFIX       = { bg = colors.bg, fg = colors.red, bold = true, italic = false },
    TodoFgFIX       = { fg = colors.white, italic = false },
    TodoSignFIX     = { fg = colors.red, italic = false },
    TodoBgWARN      = { bg = colors.bg, fg = colors.lyellow, bold = true, italic = false },
    TodoFgWARN      = { fg = colors.white, italic = false },
    TodoSignWARN    = { fg = colors.lyellow, italic = false },
    TodoBgHACK      = { bg = colors.bg, fg = colors.lyellow, bold = true, italic = false },
    TodoFgHACK      = { fg = colors.white, italic = false },
    TodoSignHACK    = { fg = colors.lyellow, italic = false },
    TodoBgPERF      = { bg = colors.bg, fg = colors.lwhite, bold = true, italic = false },
    TodoFgPERF      = { fg = colors.white, italic = false },
    TodoSignPERF    = { fg = colors.lwhite, italic = false },
    TodoBgTEST      = { bg = colors.bg, fg = colors.lwhite, bold = true, italic = false },
    TodoFgTEST      = { fg = colors.white, italic = false },
    TodoSignTEST    = { fg = colors.lwhite, italic = false },
