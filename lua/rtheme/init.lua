...
function M.setup(opts)
  ...
  local highlights = {
    ...
    RenderMarkdownH1              = { fg = colors.blue, bg = "#283750", bold = true },
    RenderMarkdownH2              = { fg = colors.purple, bg = "#3a2c50", bold = true },
    RenderMarkdownH3              = { fg = colors.yellow, bg = "#4d352c", bold = true },
    RenderMarkdownH4              = { fg = colors.cyan, bg = "#1a4b41", bold = true },
    RenderMarkdownH5              = { fg = colors.green, bg = "#364b29", bold = true },
    RenderMarkdownH6              = { fg = colors.red, bg = "#4d1f30", bold = true },
    RenderMarkdownH1Bg            = { fg = colors.blue, bg = "#283750", bold = true },
    RenderMarkdownH2Bg            = { fg = colors.purple, bg = "#3a2c50", bold = true },
    RenderMarkdownH3Bg            = { fg = colors.yellow, bg = "#4d352c", bold = true },
    RenderMarkdownH4Bg            = { fg = colors.cyan, bg = "#1a4b41", bold = true },
    RenderMarkdownH5Bg            = { fg = colors.green, bg = "#364b29", bold = true },
    RenderMarkdownH6Bg            = { fg = colors.red, bg = "#4d1f30", bold = true },
